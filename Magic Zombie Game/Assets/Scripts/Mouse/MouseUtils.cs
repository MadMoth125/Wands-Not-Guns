...
{
	public static bool instantiateEventSystem = true;
	...
	{
		return EventSystemValid() && cachedEventSystem.IsPointerOverGameObject();
	}
	...
	public static bool IsMouseOverBlockingUI(LayerMask layers)
	{
		if (!EventSystemValid()) return false;
	...
	/// </summary>
	private static bool EventSystemValid()
	{
		#if UNITY_EDITOR
