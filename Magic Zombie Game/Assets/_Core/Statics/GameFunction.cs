...
namespace Core
{
	...
	public static class GameFunction
	{
		...
		/// <summary>
		/// Get the maximum health of an enemy for a given round.
		/// Health is increased by a flat amount for the first 9 rounds, then continues by a percentage amount.
		/// Internally calls <see cref="GetMaxHealthDouble"/> for calculations, then converts the result to a float.
		/// </summary>
		/// <param name="round">The round to calculate the health for. (1-106)</param>
		/// <param name="startingHealth">The base health of the enemy.</param>
		/// <param name="flatIncreaseAmount">The amount to increase the health.</param>
		/// <param name="percentageIncreaseAmount">The percentage to increase the health.</param>
		/// <returns>The maximum health of an enemy for the given round.</returns>
		...
		/// Health is increased by a flat amount for the first 9 rounds, then continues by a percentage amount.
		/// </summary>
		/// <param name="round">The round to calculate the health for. (1-339)</param>
		/// <param name="startingHealth">The base health of the enemy.</param>
		/// <param name="flatIncreaseAmount">The amount to increase the health.</param>
		/// <param name="percentageIncreaseAmount">The percentage to increase the health.</param>
		/// <returns>The maximum health of an enemy for the given round.</returns>
		...
		/// <summary>
		/// Calculate the health increase for the first 9 rounds.
		/// </summary>
		...
		/// <summary>
		/// Calculate the health increase for the 10th round and beyond.
		/// </summary>
